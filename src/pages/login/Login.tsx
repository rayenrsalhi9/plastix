...
import loginBg from '../../assets/home/plastic_2.png';
          ...
          > 
            <div className="space-y-3 text-center sm:text-left">
              ...
              <p className="text-muted-foreground md:text-lg">
                Sign in to your Plastix account and continue your recycling journey
              </p>
            </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 mt-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-green-600 hover:bg-green-700 text-white h-11 mt-2" 
                  size="lg"
                >
                  Sign In
                </Button>
